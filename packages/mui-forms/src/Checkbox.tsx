...
type CheckboxElementComponent = <
  ...
  TValue = unknown,
>(
  props: CheckboxElementProps<TFieldValues, TName, TValue> & RefAttributes<HTMLDivElement>,
) => JSX.Element;
...
const CheckboxElement = forwardRef(function CheckboxElement<
  ...
  TName extends FieldPath<TFieldValues> = FieldPath<TFieldValues>,
  TValue = unknown,
>(props: CheckboxElementProps<TFieldValues, TName, TValue>, ref: Ref<HTMLDivElement>): JSX.Element {
  const {
    name,
    validation = {},
    required,
