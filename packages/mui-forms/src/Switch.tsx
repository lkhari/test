...
type SwitchElementComponent = <
  ...
  TValue = unknown,
>(
  props: SwitchElementProps<TFieldValues, TName, TValue> & RefAttributes<HTMLLabelElement>,
) => JSX.Element;
...
const SwitchElement = forwardRef(function SwitchElement<
  ...
  TName extends FieldPath<TFieldValues> = FieldPath<TFieldValues>,
  TValue = unknown,
>(props: SwitchElementProps<TFieldValues, TName, TValue>, ref: Ref<HTMLLabelElement>): JSX.Element {
